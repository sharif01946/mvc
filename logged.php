              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <!--Custommmer form validation system!-->
                    ...
                    <?php echo form_open('customerc/logged_info_check');?>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="Call" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="Call"  type="text">
                        </div>
                      </div>
                      <div class="item form-group">

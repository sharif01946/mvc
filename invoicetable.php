                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        ?>
                            <tr class="even pointer" id="<?php echo $invoic->id; ?>">
                              ...
                              <td class=" "><?php echo $invoic->customer ; ?></td>
                              ...
                              <td class=" last">
                                ...
                                <a href="<?php echo base_url(); ?>invoicec/invoice_edit/<?php echo $invoic->id; ?>" style="font-size:14px;color:green;margin-left:7px;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                              </td>
                            </tr> 
                          <?php
                              endforeach;

              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <!--Custommmer form validation system!-->
                    ...
                    <?php echo form_open('maincontactc/maincontact_info_check');?>
                      ...
                      <span class="section">Contact Info</span>
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="date" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="date" placeholder="Choose a date(Y/M/D).." type="date">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="calldescrip">Call Description<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="calldescrip" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="calldescrip"  type="text">
                        </div>
                      </div>
                      <div class="item form-group">
